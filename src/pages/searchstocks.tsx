...
import { StockDisplay } from 'src/components/StockDisplay/StockDisplay';
                ...
                <div className="h-full border-2 border-gray-200 border-dashed rounded-lg">
                  <div className="w-full h-screen flex justify-center items-center">
                    <div className="mx-4 text-center">
                      <h1 className="font-bold text-6xl mb-4">Enter A Stock Abbreviation</h1>
                      <div>
                        <TodoForm addTodo={(todo: string) => dispatch({ type: ADD_TODO, todo })} />
                      </div>
                    </div>
                  </div>
                </div>
