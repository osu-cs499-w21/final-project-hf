...
import { StockDisplay } from 'src/components';
                ...
                <div className="h-full border-2 border-gray-200 border-dashed rounded-lg">
                  <div className="w-full h-screen flex justify-center items-center">
                    <div className="mx-4 text-center">
                      <h1 className="font-bold text-6xl mb-4">Welcome to HiddenForest</h1>
                      <h1 className="text-gray-500 text-4xl mb-4">Main Dashboard Coming Soon</h1>
                    </div>
                  </div>
                </div>
              </div>
